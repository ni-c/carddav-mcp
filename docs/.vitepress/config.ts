...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:site_name', content: 'carddav-mcp' }],
    ['meta', { property: 'og:title', content: 'carddav-mcp' }],
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Reference', link: '/reference/tools', activeMatch: '/reference/' },
      {
        ...
        items: [
          ...
          { text: 'Releases', link: 'https://github.com/ni-c/carddav-mcp/releases' },
          { text: 'npm package', link: 'https://www.npmjs.com/package/@ni-c/carddav-mcp' },
        ],
      },
    ],
      ...
      '/guide/': [
        {
          text: 'Introduction',
          items: [
            { text: 'What is carddav-mcp?', link: '/guide/' },
    ...
    socialLinks: [{ icon: 'github', link: 'https://github.com/ni-c/carddav-mcp' }],

    search: { provider: 'local' },

    editLink: {
      pattern: 'https://github.com/ni-c/carddav-mcp/edit/main/docs/:path',
